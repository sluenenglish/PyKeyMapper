...
class AltBrackets(CustomModifier):
    ...
    macros = {
        ...
        CODE.KEY_D: lambda input_event_code: push_key(CODE.KEY_9, modifiers=[CODE.KEY_LEFTSHIFT]),
        CODE.KEY_F: lambda input_event_code: push_key(CODE.KEY_0, modifiers=[CODE.KEY_LEFTSHIFT]),
